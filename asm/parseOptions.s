...
# ./parseOptions.c:5:     struct options opt = {
	mov	DWORD PTR -32[rbp], 0	# opt.input_mode,
	mov	DWORD PTR -28[rbp], 0	# opt.output_mode,
	mov	QWORD PTR -24[rbp], 0	# opt.input_file,
	mov	QWORD PTR -16[rbp], 0	# opt.output_file,
	mov	DWORD PTR -8[rbp], 0	# opt.show_help,
	mov	DWORD PTR -4[rbp], 0	# opt.valid,
...
# ./parseOptions.c:15:         char key = argv[i][1];
	mov	eax, DWORD PTR -36[rbp]	# tmp105, i
	cdqe
...
# ./parseOptions.c:23:                 return opt;
	...
	mov	rax, QWORD PTR -32[rbp]	# tmp114, opt
	mov	rdx, QWORD PTR -24[rbp]	#, opt
	mov	QWORD PTR [rcx], rax	# <retval>, tmp114
	mov	QWORD PTR 8[rcx], rdx	# <retval>,
	mov	rax, QWORD PTR -16[rbp]	# tmp115, opt
	mov	rdx, QWORD PTR -8[rbp]	#, opt
...
# ./parseOptions.c:25:             opt.input_file = argv[i + 1];
	mov	eax, DWORD PTR -36[rbp]	# tmp116, i
	cdqe
	add	rax, 1	# _8,
...
# ./parseOptions.c:25:             opt.input_file = argv[i + 1];
	mov	QWORD PTR -24[rbp], rax	# opt.input_file, _11
# ./parseOptions.c:26:             opt.input_mode = FROM_FILE;
	mov	DWORD PTR -32[rbp], 1	# opt.input_mode,
# ./parseOptions.c:27:             ++i;
	add	DWORD PTR -36[rbp], 1	# i,
	jmp	.L7	#
.L5:
# ./parseOptions.c:28:         } else if (key == 'o') {
	cmp	BYTE PTR -37[rbp], 111	# key,
	jne	.L8	#,
# ./parseOptions.c:29:             if (i + 1 >= argc) {
	mov	eax, DWORD PTR -36[rbp]	# tmp118, i
	add	eax, 1	# _12,
# ./parseOptions.c:29:             if (i + 1 >= argc) {
...
# ./parseOptions.c:31:                 return opt;
	...
	mov	rax, QWORD PTR -32[rbp]	# tmp121, opt
	mov	rdx, QWORD PTR -24[rbp]	#, opt
	mov	QWORD PTR [rcx], rax	# <retval>, tmp121
	mov	QWORD PTR 8[rcx], rdx	# <retval>,
	mov	rax, QWORD PTR -16[rbp]	# tmp122, opt
	mov	rdx, QWORD PTR -8[rbp]	#, opt
...
# ./parseOptions.c:33:             opt.output_file = argv[i + 1];
	mov	eax, DWORD PTR -36[rbp]	# tmp123, i
	cdqe
	add	rax, 1	# _15,
...
# ./parseOptions.c:33:             opt.output_file = argv[i + 1];
	mov	QWORD PTR -16[rbp], rax	# opt.output_file, _18
# ./parseOptions.c:34:             opt.output_mode = TO_FILE;
	mov	DWORD PTR -28[rbp], 1	# opt.output_mode,
# ./parseOptions.c:35:             ++i;
	add	DWORD PTR -36[rbp], 1	# i,
	jmp	.L7	#
.L8:
# ./parseOptions.c:36:         } else if (key == 'r') {
	cmp	BYTE PTR -37[rbp], 114	# key,
	jne	.L10	#,
# ./parseOptions.c:37:             opt.input_mode = FROM_RANDOM;
	mov	DWORD PTR -32[rbp], 2	# opt.input_mode,
	jmp	.L7	#
.L10:
# ./parseOptions.c:39:             fprintf(stderr, "Key %s not recognized.\n", argv[i]);
	mov	eax, DWORD PTR -36[rbp]	# tmp125, i
	cdqe
...
# ./parseOptions.c:40:             return opt;
	...
	mov	rax, QWORD PTR -32[rbp]	# tmp129, opt
	mov	rdx, QWORD PTR -24[rbp]	#, opt
	mov	QWORD PTR [rcx], rax	# <retval>, tmp129
	mov	QWORD PTR 8[rcx], rdx	# <retval>,
	mov	rax, QWORD PTR -16[rbp]	# tmp130, opt
	mov	rdx, QWORD PTR -8[rbp]	#, opt
...
.L2:
# ./parseOptions.c:14:     for (int i = 1; i < argc; ++i) {
	mov	eax, DWORD PTR -36[rbp]	# tmp131, i
...
# ./parseOptions.c:44:     return opt;
	...
	mov	rax, QWORD PTR -32[rbp]	# tmp133, opt
	mov	rdx, QWORD PTR -24[rbp]	#, opt
	mov	QWORD PTR [rcx], rax	# <retval>, tmp133
	mov	QWORD PTR 8[rcx], rdx	# <retval>,
	mov	rax, QWORD PTR -16[rbp]	# tmp134, opt
	mov	rdx, QWORD PTR -8[rbp]	#, opt
